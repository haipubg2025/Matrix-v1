...
export const FANTASY_HUMAN_ARCHETYPE: GameArchetype = {
  ...
  description: 'Thế giới trung cổ phương Tây tàn khốc, nơi các vương quốc tranh giành lãnh thổ bằng gươm giáo và cấm thuật. Tuyệt đối không có rồng hay quái vật, chỉ có lòng tham và tham vọng của con người. Ma pháp hiện diện trong từng hơi thở, từ việc thắp sáng phố phường đến những trận chiến vạn quân. Nô lệ là tài sản và là nền tảng của mọi đế chế. [MC: Nam, Linh hoạt thân phận - Kẻ kiến tạo trật tự mới hoặc kẻ bị nghiền nát bởi bánh xe lịch sử].',
  features: ['Vương Quyền Chi Chiến', 'Hiệp Sĩ Đạo', 'Ma Pháp Đời Sống', 'Chế Độ Nô Lệ'],
  subScenarios: createSubScenarios('fh', Data),
  defaultMcNames: ['Alaric von Astrea', 'Cedric Stormborn', 'Valerius Ironheart', 'Julian Goldmont', 'Silas Nightshade'],
