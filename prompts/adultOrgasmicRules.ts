...
export const ADULT_ORGASMIC_RULES = `
1. LOGIC LÊN ĐỈNH CỦA NỮ (FEMALE ORGASM DYNAMICS):
   ...
   - Phản ứng vùng kín: 
      * Tử cung và vách lồn co thắt (máy động) kịch liệt, mút chặt lấy cu MC không rời.
...
3. LOGIC TUÔN TRÀO DỊCH THỂ (SQUIRTING & FLUID PHYSICS):
   - Trạng thái tuôn trào: 
      * Nước lồn phun ra thành tia (squirt), xối xả như vỡ đập, tưới đẫm lên thân cu và bắp đùi MC.
...
4. TRẠNG THÁI SAU CỰC KHOÁI (AFTERGLOW):
   ...
   - Tâm lý: Lệ thuộc hoàn toàn vào MC, khao khát được vuốt ve hoặc được MC "nhồi đầy" tinh dịch ngay lập tức.
`;
