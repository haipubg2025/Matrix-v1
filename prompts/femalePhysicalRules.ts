...
- breasts: Bầu ngực/Vú (Hình dáng tròn trịa/giọt nước, kích cỡ Cup A-H, độ nặng, độ nảy rưng rinh). PHẢI KHỚP SỐ ĐO V1.
- nipples: Núm vú/Đầu vú (Màu sắc hồng nhạt/thâm nứng, trạng thái mềm mại/sưng cứng như hạt đậu).
- areola: Quầng vú (Độ rộng, màu sắc, sự co thắt khi bị kích thích).
- cleavage: Rãnh ngực (Độ sâu, sự nhễ nhại mồ hôi).
...
- labia: Môi lớn & Môi bé (Độ dày, màu sắc hồng hào/thâm nứng, trạng thái mọng nước).
