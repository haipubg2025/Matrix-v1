...
- CHI TIẾT THEO THỂ LOẠI (GENRE-SPECIFIC HAIR VOCABULARY):
  + 1. URBAN_NORMAL (Đô Thị Bình Thường): 
    * Kiểu dáng Salon: 
       Uốn: Xoăn sóng nước (Water Wave), uốn cụp đuôi (C-curl), uốn xù mì (Hippie), xoăn lọn to gợi cảm.
       Cắt: Layer bay bổng, Bob cá tính, mái thưa Hàn Quốc, Hime-cut dâm mị.
       Ép: thẳng chải chuốt sang trọng, layer ngang vai, kiểu layer dài.
    * Màu sắc (Dyeing): 
  ...
  + 6. WUXIA (Kiếm Hiệp / Võ Lâm): 
     * Kiểu dáng: Tóc buộc đuôi ngựa hiên ngang, tóc xõa lả lướt khi thi triển khinh công, búi tóc tà mị của nữ ma đầu.
     * Phụ kiện: Trâm cài bằng ngọc bích, dải lụa đỏ thắm quấn quanh tóc.
