...
export const ADULT_CONTEXTUAL_RULES = `
...
2. BỐI CẢNH CƯỠNG ÉP & TRỪNG PHẠT (FORCED/PUNISHMENT):
   ...
   - Động từ bắt buộc: Cưỡng đoạt, Làm nhục, Chà đạp, Nện nát, Địt mạnh, Giày xéo.
   - Cảm xúc: Nhục nhã, uất hận, đau đớn, nhồi đầy tinh dịch trong uất ức.
